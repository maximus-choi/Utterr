...
Workflow:
  ...
  Step 2. Run live diarization. Every speech window is classified as exactly
          ...
          time-aligned WAV streams using the diarized segment times.
...
class MainWindow(QMainWindow):
    ...
    def _toggle_diarization(self):
        ...
        # Fresh start — reset timeline/source-audio storage and switch phase.
        ...
        self.status_label.setText("Diarizing… click End Diarization + Export WAV to save both streams.")
