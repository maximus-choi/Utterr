...
class WeSpeakerEncoder(QThread):
    ...
    def run(self):
        try:
            ...
            print("Make sure you have installed: pip install pyannote.audio")
            raise e
    ...
    def _compute_emb(self, audio, sr=16000):
        ...
        try:
            ...
            # Create a dictionary with waveform and sample rate
            audio_dict = {
                "waveform": waveform,
                "sample_rate": sr
            }
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Real-time Speaker Timeline with Auto-Clustering (WeSpeaker + Silero VAD)")
        self.encoder = None
    ...
    def _init_app(self):
        ...
        self.status_label.setText("Loading models... (WeSpeaker Encoder + VAD)")
